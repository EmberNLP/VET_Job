...
ads_vectors = open_file("vectors/ads_vectors.txt", "vector")
vet_vectors = open_file("vectors/vet_vectors.txt", "vector")
...
pd.DataFrame(vet_similarity_matrix, index = vet_category, columns = vet_category).to_csv("results/vet_similarity.csv")
